...
function HomePage() {
      ...
      if (response && Array.isArray(response)) {
        ...
        const formattedPosts = response.map(post => ({
          ...
          author: {
            ...
            profileImage: post.author?.profileImage || "/placeholder.svg?height=40&width=40",
          ...
          comments: post.comments?.map(comment => ({
            ...
            author: {
              ...
              role: "user",
              profileImage: comment.profileImage || "/placeholder.svg?height=40&width=40",
            },
  ...
  const handlePostSubmit = async () => {
    ...
    try {
      ...
      const response = await makeCommunityPost(postData)
          ...
          <div className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-medium">Alumni Networking Mixer</h4>
                  <p className="text-sm text-muted-foreground">May 15, 2025 • 6:00 PM</p>
                  <p className="text-sm mt-1">Connect with fellow alumni and expand your professional network.</p>
                </div>
                <div>
                  <h4 className="font-medium">Career Fair</h4>
                  <p className="text-sm text-muted-foreground">June 2, 2025 • 10:00 AM</p>
                  <p className="text-sm mt-1">Meet recruiters from top companies in the industry.</p>
                </div>
                <div>
                  <h4 className="font-medium">Tech Talk: AI in Healthcare</h4>
                  <p className="text-sm text-muted-foreground">June 10, 2025 • 2:00 PM</p>
                  <p className="text-sm mt-1">Learn about the latest applications of AI in healthcare.</p>
                </div>
              </CardContent>
              <CardFooter>
