...
import { updateUserProfileImageOnly } from "../../../api/user";
...
export default function ProfilePage() {
  ...
  const handleImageChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await updateUserProfileImageOnly(formData);
      console.log("Image upload response:", response);

      if (response && response.url) {
        // Update the profile and localStorage
        const updatedProfile = { ...profile, profileImage: response.url };
      ...
      <AppLayout>
        <div className="container mx-auto py-8 px-4">
          <div className="flex flex-col gap-4 animate-pulse">
            <div className="h-48 bg-gradient-to-r from-indigo-100 to-blue-100 rounded-lg mb-8"></div>
            <div className="h-32 w-32 rounded-full bg-gradient-to-r from-blue-100 to-indigo-200 mx-auto -mt-24 border-4 border-white"></div>
      ...
      <AppLayout>
        <div className="container mx-auto py-8 px-4 text-center">
          <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden p-8">
            ...
            <Button asChild className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white hover:from-blue-600 hover:to-indigo-700">
  ...
  return (
    <AppLayout>
      ...
      {/* Header Banner */}
      <div className="w-full h-48 bg-gradient-to-r from-blue-500 to-indigo-600 relative">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              <div className="flex flex-col items-center gap-4 z-10">
                <div className="relative group">
                  <Avatar 
                    className={`h-32 w-32 border-4 border-white shadow ${isCurrentUser ? 'cursor-pointer' : ''}`}
              ...
              <div className="flex-1 pt-4">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                  <div>
                    ...
                    <div className="flex items-center mt-1">
                      <Badge className="bg-gradient-to-r from-blue-500 to-indigo-600 mr-2 text-white">
                  ...
                  {isCurrentUser && (
                    <Button variant="outline" className="hidden md:block mt-4 md:mt-0">
                      Export Profile
                    </Button>
                  )}
                </div>
                ...
                <div className="flex items-center mt-4 gap-2">
                  {profile.linkedIn && (
                    <a href={profile.linkedIn} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-100 rounded-full hover:bg-blue-100 transition-colors">
                      <Linkedin className="h-4 w-4 text-blue-500" />
                    </a>
                  )}
                  {profile.twitter && (
                    <a href={profile.twitter} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-100 rounded-full hover:bg-blue-100 transition-colors">
                      <Twitter className="h-4 w-4 text-blue-500" />
                    </a>
                  )}
                  {profile.github && (
                    <a href={profile.github} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-100 rounded-full hover:bg-blue-100 transition-colors">
                      <Github className="h-4 w-4 text-blue-500" />
                    </a>
                  )}
                  {profile.website && (
                    <a href={profile.website} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-100 rounded-full hover:bg-blue-100 transition-colors">
              ...
              {profile.experiences && profile.experiences.length > 0 ? (
                <div className="space-y-8">
                  {profile.experiences.map((exp: any, index: number) => (
                    <div
                      key={index}
                      className="relative pl-8 border-l-2 border-blue-100 last:border-0 pb-6 last:pb-0"
                    >
              ...
              {profile.skills && profile.skills.length > 0 ? (
                <div className="flex flex-wrap gap-2">
                  {profile.skills.map((skill: string, index: number) => (
                    <Badge key={index} variant="secondary" className="px-3 py-1 bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 hover:from-blue-100 hover:to-indigo-100 transition-colors border border-blue-100">
                      {skill}
                    </Badge>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {profile.achievements.map((ach: any, index: number) => (
                  <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow border border-gray-100">
                    {ach.image && (
                      <div 
                        className="h-48 w-full relative cursor-pointer group"
                        onClick={() => viewImage(ach.image)}
                      >
                        <Image
      ...
      {showImageModal && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4" onClick={() => setShowImageModal(false)}>
          <div className="relative max-w-4xl max-h-screen w-full bg-white rounded-lg overflow-hidden" onClick={e => e.stopPropagation()}>
